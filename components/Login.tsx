...
const Login = ({ navigation }) => {
  ...
  const handleLogin = async () => {
    const res = await logIn(AuthMethod.EMAIL_AND_PASSWORD, { email, password })
    ...
    <View style={{ flex: 1, backgroundColor: '#fbd9e3' }}>
      ...
      <View style={styles.bottomView}>
        <View style={{ padding: 40 }}>
          <Text style={{ color: 'white', fontSize: 34 }}>Welcome</Text>
          ...
          <View style={{ alignItems: 'center', marginTop: 25 }}>
            ...
            <View style={{ marginTop: 30 }}>
              <TouchableOpacity
                ...
                disabled={!validMail}
                style={validMail ? styles.btn : { ...styles.btn, backgroundColor: '#D3D3D3' }}>
